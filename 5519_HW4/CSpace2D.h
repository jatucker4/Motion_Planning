...
#ifndef INC_5519_HW4_CSPACE2D_H
#define INC_5519_HW4_CSPACE2D_H
...
void CSpace2D::createBrushGrid(){
    ...
    int index = 1;
    // Complete the brush fire grid by incrementing the distanceToNode for neighboring cells
